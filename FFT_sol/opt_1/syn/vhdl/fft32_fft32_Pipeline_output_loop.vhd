...
attribute shreg_extract : string;
    ...
    signal icmp_ln152_fu_573_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal out_stream_TDATA_blk_n : STD_LOGIC;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal tmp_s_fu_589_p34 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_s_reg_762 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal tmp_1_fu_659_p34 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_1_reg_767 : STD_LOGIC_VECTOR (15 downto 0);
    signal icmp_ln156_fu_729_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln156_reg_772 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_fu_170 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln152_fu_579_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal trunc_ln152_fu_585_p1 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    mux_32_5_16_1_1_U433 : component fft32_mux_32_5_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    mux_32_5_16_1_1_U434 : component fft32_mux_32_5_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln152_fu_573_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln152_fu_573_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln152_fu_579_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv6_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln152_fu_573_p2)
    begin
        if (((icmp_ln152_fu_573_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln152_fu_573_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv6_20) else "0";
    icmp_ln156_fu_729_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv6_1F) else "0";
    ...
    tmp_2_fu_740_p4 <= ((icmp_ln156_reg_772 & tmp_1_reg_767) & tmp_s_reg_762);
    trunc_ln152_fu_585_p1 <= ap_sig_allocacmp_i_1(5 - 1 downto 0);
end behav;
