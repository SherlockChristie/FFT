...
extern "C" void fft32(__cosim_s6__*, __cosim_s6__*);
extern "C" void apatb_fft32_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream) {
using hls::sim::createStream;
auto* sin_stream = createStream((hls::stream<__cosim_s6__>*)__xlx_apatb_param_in_stream);
  //Create input buffer for out_stream
  ap_apatb_out_stream_cap_bc = __xlx_out_stream_V_size_Reader.read_size();
  __cosim_s6__* __xlx_out_stream_input_buffer= new __cosim_s6__[ap_apatb_out_stream_cap_bc];
auto* sout_stream = createStream((hls::stream<__cosim_s6__>*)__xlx_apatb_param_out_stream);
  // DUT call
  fft32(sin_stream->data<__cosim_s6__>(), sout_stream->data<__cosim_s6__>());
sin_stream->transfer((hls::stream<__cosim_s6__>*)__xlx_apatb_param_in_stream);
sout_stream->transfer((hls::stream<__cosim_s6__>*)__xlx_apatb_param_out_stream);
}
