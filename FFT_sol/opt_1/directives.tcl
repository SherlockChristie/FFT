...
set_directive_array_partition -type complete -dim 1 "fft32" stage0
set_directive_array_partition -type complete -dim 1 "fft32" stage1
set_directive_array_partition -type complete -dim 1 "fft32" stage2
set_directive_pipeline -II 4 "fft32/input_loop"
