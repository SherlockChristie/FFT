...
$(ObjDir)/fft32_tb.cpp_pre.cpp.tb.o : fft32_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling fft32_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/FFT32_sol.cpp_pre.cpp.tb.o : FFT32_sol.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling FFT32_sol.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
