...
using hls::sim::Byte;
extern "C" void fft32(long long*, long long*);
extern "C" void apatb_fft32_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream) {
using hls::sim::createStream;
auto* sin_stream = createStream((hls::stream<long long>*)__xlx_apatb_param_in_stream);
  //Create input buffer for out_stream
  ap_apatb_out_stream_cap_bc = __xlx_out_stream_V_size_Reader.read_size();
  long long* __xlx_out_stream_input_buffer= new long long[ap_apatb_out_stream_cap_bc];
auto* sout_stream = createStream((hls::stream<long long>*)__xlx_apatb_param_out_stream);
  // DUT call
  fft32(sin_stream->data<long long>(), sout_stream->data<long long>());
sin_stream->transfer((hls::stream<long long>*)__xlx_apatb_param_in_stream);
sout_stream->transfer((hls::stream<long long>*)__xlx_apatb_param_out_stream);
}
