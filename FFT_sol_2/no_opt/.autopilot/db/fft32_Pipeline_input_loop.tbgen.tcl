...
set C_modelArgList {
	...
	{ data_real int 16 regular {array 32 { 0 3 } 0 1 }  }
	{ data_imag int 16 regular {array 32 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "in_stream", "interface" : "fifo", "bitwidth" : 33, "direction" : "READONLY"} , 
 	{ "Name" : "data_real", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_imag", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ data_real_address0 sc_out sc_lv 5 signal 1 } 
	{ data_real_ce0 sc_out sc_logic 1 signal 1 } 
	{ data_real_we0 sc_out sc_logic 1 signal 1 } 
	{ data_real_d0 sc_out sc_lv 16 signal 1 } 
	{ data_imag_address0 sc_out sc_lv 5 signal 2 } 
	{ data_imag_ce0 sc_out sc_logic 1 signal 2 } 
	{ data_imag_we0 sc_out sc_logic 1 signal 2 } 
	{ data_imag_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_real_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_real", "role": "d0" }} , 
 	...
 	{ "name": "data_imag_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_imag", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	data_real { ap_memory {  { data_real_address0 mem_address 1 5 }  { data_real_ce0 mem_ce 1 1 }  { data_real_we0 mem_we 1 1 }  { data_real_d0 mem_din 1 16 } } }
	data_imag { ap_memory {  { data_imag_address0 mem_address 1 5 }  { data_imag_ce0 mem_ce 1 1 }  { data_imag_we0 mem_we 1 1 }  { data_imag_d0 mem_din 1 16 } } }
}
