...
module AESL_autofifo_out_stream (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.fft32.autotvin_out_stream.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.fft32.autotvout_out_stream.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 33;
