...
always @ (ap_sig_allocacmp_i) begin
    for (ap_tvar_int_0 = 5 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 4 - 0) begin
            or_ln56_3_fu_116_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            or_ln56_3_fu_116_p4[ap_tvar_int_0] = ap_sig_allocacmp_i[4 - ap_tvar_int_0];
        end
    end
end
...
assign zext_ln86_fu_126_p1 = or_ln56_3_fu_116_p4;
