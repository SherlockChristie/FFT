; ModuleID = 'D:/Vivado/FFT_sol/FFT_sol_2/opt3_overall_pipeline/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_fft32_hw(%"class.hls::stream<axis_data, 0>"* %in_stream_copy, %"class.hls::stream<axis_data, 0>"* %out_stream_copy)
...
declare void @apatb_fft32_hw(%"class.hls::stream<axis_data, 0>"*, %"class.hls::stream<axis_data, 0>"*)
...
define void @fft32_hw_stub_wrapper(%"class.hls::stream<axis_data, 0>"*, %"class.hls::stream<axis_data, 0>"*) #6 {
entry:
  ...
  call void @fft32_hw_stub(%"class.hls::stream<axis_data, 0>"* %0, %"class.hls::stream<axis_data, 0>"* %1)
...
attributes #7 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="48" "xlx.source"="user" }
