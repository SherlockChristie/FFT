...
set_directive_array_partition -type cyclic -factor 4 "fft32" stage0
set_directive_array_partition -type block -factor 8 "fft32" stage1
set_directive_array_partition -type cyclic -factor 2 "fft32" stage2
...
set_directive_pipeline -II 32 "fft32"
