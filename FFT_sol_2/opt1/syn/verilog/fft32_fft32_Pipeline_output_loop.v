...
wire   [0:0] icmp_ln161_fu_729_p2;
reg   [0:0] icmp_ln161_reg_772;
reg   [5:0] i_fu_170;
wire   [5:0] add_ln157_fu_579_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_i_1;
reg    ap_block_pp0_stage0_01001;
wire   [4:0] trunc_ln157_fu_585_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln157_fu_573_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln157_fu_573_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln157_fu_573_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln157_fu_579_p2 = (ap_sig_allocacmp_i_1 + 6'd1);
...
assign icmp_ln157_fu_573_p2 = ((ap_sig_allocacmp_i_1 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln161_fu_729_p2 = ((ap_sig_allocacmp_i_1 == 6'd31) ? 1'b1 : 1'b0);

assign out_stream_TDATA = tmp_2_fu_740_p4;

assign tmp_2_fu_740_p4 = {{{icmp_ln161_reg_772}, {tmp_1_reg_767}}, {tmp_reg_762}};

assign trunc_ln157_fu_585_p1 = ap_sig_allocacmp_i_1[4:0];
