...
set C_modelName {sin<16, 4>}
set C_modelType { int 14 }
set C_modelArgList {
	{ x_val int 14 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "x_val", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_val", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "x_val", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_cordic_circ_apfixed_18_3_0_s_fu_48", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_14ns_22ns_35_1_1_U15", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_2ns_16ns_18ns_18_4_1_U16", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	x_val { ap_none {  { x_val in_data 0 14 } } }
}
