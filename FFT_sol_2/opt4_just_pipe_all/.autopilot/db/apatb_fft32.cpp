...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_stream "../tv/rtldatafile/rtl.fft32.autotvout_out_stream.dat"
...
extern "C"
void fft32_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_fft32_hw(void* __xlx_apatb_param_in_stream, void* __xlx_apatb_param_out_stream)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_in_stream;
  ...
  port1.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_out_stream;
  port1.hasWrite = true;
  ...
  try {
    ...
    fft32_hw_stub_wrapper(__xlx_apatb_param_in_stream, __xlx_apatb_param_out_stream);
    port1.buffer();
