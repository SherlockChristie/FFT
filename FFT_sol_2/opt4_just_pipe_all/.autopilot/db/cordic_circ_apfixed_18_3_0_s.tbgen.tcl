...
set C_modelArgList {
	{ z_read int 17 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "z_read", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ z_read sc_in sc_lv 17 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "z_read", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "z_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	z_read { ap_none {  { z_read in_data 0 17 } } }
}
