set SynModuleInfo {
  ...
  {SRCNAME fft32_Pipeline_2 MODELNAME fft32_Pipeline_2 RTLNAME fft32_fft32_Pipeline_2}
  ...
  {SRCNAME fft32_Pipeline_output_loop MODELNAME fft32_Pipeline_output_loop RTLNAME fft32_fft32_Pipeline_output_loop
    SUBMODULES {
      {MODELNAME fft32_mux_2_1_16_1_1 RTLNAME fft32_mux_2_1_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME fft32 MODELNAME fft32 RTLNAME fft32 IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME fft32_stage2_real_RAM_AUTO_1R1W RTLNAME fft32_stage2_real_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
