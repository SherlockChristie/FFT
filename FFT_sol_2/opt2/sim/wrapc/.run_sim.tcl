...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Vivado/Vitis_HLS/2023.1/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vitis_HLS/2023.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vitis_HLS/2023.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vivado/Vitis_HLS/2023.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fft32.autotvin.dat"
	set constFileTvOut       "fft32.autotvout.dat"
	set constFileHdlTvIn     "fft32.autohdltvin.dat"
	set constFileHdlTvOut    "fft32.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
